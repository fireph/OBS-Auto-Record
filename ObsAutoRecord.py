...
class SysTrayIcon(object):
    ...
    def __init__(self,
        ...
        self.obs_auto_record = obs_auto_record
        self.icon = icon
        ...
        self.obs_auto_record.set_on_state_change(self.update_icon_from_state)
...
def get_apps_to_record():
    ...
    default_apps = ', '.join(['destiny2.exe', 'Wow.exe', 'Wow-64.exe'])
